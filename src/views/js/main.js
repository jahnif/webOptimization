...
function getAdj(x) {
    switch (x) {
        case "dark":
            var dark = ["dark", "morbid", "scary", "spooky", "gothic", "deviant", "crecepy", "sadistic", "black", "dangerous", "dejected", "haunted",
...
// Moved pizzasDiv outside the for loop so the query isn't run each time a pizza is generated
...
function updatePositions() {
    ...
    // Determine the scroll distance from the top of the page
